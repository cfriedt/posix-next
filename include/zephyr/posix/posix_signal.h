...
struct sigevent {
	...
	/**
	 * Thread the signal is directed to with SIGEV_THREAD_ID (Linux-compatible extension).
	 *
	 * On Zephyr this carries a pthread_t value rather than a Linux gettid() id.
	 * TODO(k_process): with process support and gettid(), carry a kernel thread id.
	 */
