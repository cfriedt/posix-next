...
BUILD_ASSERT(_POSIX_SPORADIC_SERVER == 200809L, "_POSIX_SPORADIC_SERVER is not defined to 200809L");
...
ZTEST_SUITE(posix_sporadic_server, NULL, NULL, NULL, NULL, NULL);
