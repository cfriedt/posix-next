...
{
	return z_getpw_r(name, -1, pwd, buffer, bufsize, result);
}

int getpwuid_r(uid_t uid, struct passwd *pwd, char *buffer, size_t bufsize, struct passwd **result)
{
	return z_getpw_r(NULL, uid, pwd, buffer, bufsize, result);
}

int getgrnam_r(const char *name, struct group *grp, char *buffer, size_t bufsize,
	       struct group **result)
{
	return z_getgr_r(name, -1, grp, buffer, bufsize, result);
}

int getgrgid_r(gid_t gid, struct group *grp, char *buffer, size_t bufsize, struct group **result)
{
	return z_getgr_r(NULL, gid, grp, buffer, bufsize, result);
}
