...
ZTEST(posix_c_lib_ext, test_fnmatch)
{
	...
	zexpect_equal(fnmatch("*.a", "foo.c", 0), FNM_NOMATCH);
	zexpect_ok(fnmatch("*.c", ".foo.c", 0));
	zexpect_equal(fnmatch("*.c", ".foo.c", FNM_PERIOD), FNM_NOMATCH);
	zexpect_ok(fnmatch("*.c", "foo.c", FNM_PERIOD));
	zexpect_equal(fnmatch("a\\*.c", "a*.c", FNM_NOESCAPE), FNM_NOMATCH);
	zexpect_equal(fnmatch("a\\*.c", "ax.c", 0), FNM_NOMATCH);
	zexpect_ok(fnmatch("a[xy].c", "ax.c", 0));
	zexpect_ok(fnmatch("a[!y].c", "ax.c", 0));
	zexpect_equal(fnmatch("a[a/z]*.c", "a/x.c", FNM_PATHNAME), FNM_NOMATCH);
	zexpect_ok(fnmatch("a/*.c", "a/x.c", FNM_PATHNAME));
	zexpect_equal(fnmatch("a*.c", "a/x.c", FNM_PATHNAME), FNM_NOMATCH);
	zexpect_ok(fnmatch("*/foo", "/foo", FNM_PATHNAME));
	zexpect_ok(fnmatch("-O[01]", "-O1", 0));
	/* '\' in pattern escapes ']'. bracket expression is incomplete. error */
	zexpect_equal(fnmatch("[[?*\\]", "\\", 0), FNM_NOMATCH);
	/* '\' in pattern does not escape ']'. bracket expression complete. '\' matches input '\' */
	zexpect_ok(fnmatch("[[?*\\]", "\\", FNM_NOESCAPE));
	/* '\' in pattern escapes '\', match '\' */
	zexpect_ok(fnmatch("[[?*\\\\]", "\\", 0));
	/*
	...
	zexpect_ok(fnmatch("[!]a-]", "b", 0));
	zexpect_ok(fnmatch("[]-_]", "^", 0));
	zexpect_ok(fnmatch("[!]-_]", "X", 0));
	zexpect_equal(fnmatch("??", "-", 0), FNM_NOMATCH);
	zexpect_equal(fnmatch("*LIB*", "lib", FNM_PERIOD), FNM_NOMATCH);
	zexpect_ok(fnmatch("a[/]b", "a/b", 0));
	zexpect_equal(fnmatch("a[/]b", "a/b", FNM_PATHNAME), FNM_NOMATCH);
	zexpect_ok(fnmatch("[a-z]/[a-z]", "a/b", 0));
	zexpect_equal(fnmatch("*", "a/b", FNM_PATHNAME), FNM_NOMATCH);
	zexpect_equal(fnmatch("*[/]b", "a/b", FNM_PATHNAME), FNM_NOMATCH);
	zexpect_equal(fnmatch("*[b]", "a/b", FNM_PATHNAME), FNM_NOMATCH);
	zexpect_equal(fnmatch("[*]/b", "a/b", 0), FNM_NOMATCH);
	zexpect_ok(fnmatch("[*]/b", "*/b", 0));
	zexpect_equal(fnmatch("[?]/b", "a/b", 0), FNM_NOMATCH);
	zexpect_ok(fnmatch("[?]/b", "?/b", 0));
	zexpect_ok(fnmatch("[[a]/b", "a/b", 0));
	zexpect_ok(fnmatch("[[a]/b", "[/b", 0));
	zexpect_equal(fnmatch("\\*/b", "a/b", 0), FNM_NOMATCH);
	zexpect_ok(fnmatch("\\*/b", "*/b", 0));
	zexpect_equal(fnmatch("\\?/b", "a/b", 0), FNM_NOMATCH);
	zexpect_ok(fnmatch("\\?/b", "?/b", 0));
	...
	zexpect_ok(fnmatch("??"
			   "/b",
			   "aa/b", 0));
	zexpect_ok(fnmatch("???b", "aa/b", 0));
	zexpect_equal(fnmatch("???b", "aa/b", FNM_PATHNAME), FNM_NOMATCH);
	zexpect_equal(fnmatch("?a/b", ".a/b", FNM_PATHNAME | FNM_PERIOD), FNM_NOMATCH);
	zexpect_equal(fnmatch("a/?b", "a/.b", FNM_PATHNAME | FNM_PERIOD), FNM_NOMATCH);
	zexpect_equal(fnmatch("*a/b", ".a/b", FNM_PATHNAME | FNM_PERIOD), FNM_NOMATCH);
	zexpect_equal(fnmatch("a/*b", "a/.b", FNM_PATHNAME | FNM_PERIOD), FNM_NOMATCH);
	zexpect_equal(fnmatch("[.]a/b", ".a/b", FNM_PATHNAME | FNM_PERIOD), FNM_NOMATCH);
	zexpect_equal(fnmatch("a/[.]b", "a/.b", FNM_PATHNAME | FNM_PERIOD), FNM_NOMATCH);
	zexpect_ok(fnmatch("*/?", "a/b", FNM_PATHNAME | FNM_PERIOD));
	zexpect_ok(fnmatch("?/*", "a/b", FNM_PATHNAME | FNM_PERIOD));
	zexpect_ok(fnmatch(".*/?", ".a/b", FNM_PATHNAME | FNM_PERIOD));
	zexpect_ok(fnmatch("*/.?", "a/.b", FNM_PATHNAME | FNM_PERIOD));
	zexpect_equal(fnmatch("*/*", "a/.b", FNM_PATHNAME | FNM_PERIOD), FNM_NOMATCH);
	zexpect_ok(fnmatch("*?*/*", "a/.b", FNM_PERIOD));
	zexpect_ok(fnmatch("*[.]/b", "a./b", FNM_PATHNAME | FNM_PERIOD));
	zexpect_ok(fnmatch("*[[:alpha:]]/"
			   "*[[:alnum:]]",
			   "a/b", FNM_PATHNAME));
	zexpect_ok(fnmatch("*[![:digit:]]*/[![:d-d]", "a/b", FNM_PATHNAME), 0);
	zexpect_ok(fnmatch("*[![:digit:]]*/[[:d-d]", "a/[", FNM_PATHNAME), 0);
	zexpect_equal(fnmatch("*[![:digit:]]*/[![:d-d]", "a/[", FNM_PATHNAME), FNM_NOMATCH);
	zexpect_ok(fnmatch("a?b", "a.b", FNM_PATHNAME | FNM_PERIOD));
	zexpect_ok(fnmatch("a*b", "a.b", FNM_PATHNAME | FNM_PERIOD));
	zexpect_ok(fnmatch("a[.]b", "a.b", FNM_PATHNAME | FNM_PERIOD));
	...
	zexpect_equal(fnmatch("[[:foobarbaz:]]", "Z", 0), FNM_NOMATCH);
}
