...
/** @brief CAN bus address family. */
#define AF_CAN ZSOCK_AF_CAN
/** @brief Link-layer packet address family. */
#define AF_PACKET ZSOCK_AF_PACKET
/** @brief Network management address family. */
...
/** @brief CAN bus protocol family. */
#define PF_CAN ZSOCK_PF_CAN
/** @brief Link-layer packet protocol family. */
#define PF_PACKET ZSOCK_PF_PACKET

/** @brief Link-layer socket address (alias for zsock_sockaddr_ll). */
