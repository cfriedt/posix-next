...
`POSIX sample applications <https://github.com/cfriedt/posix-next/tree/main/samples/posix>`_.
...
The :kconfig:option:`CONFIG_POSIX_API` should be considered deprecated and will be removed. It
shall not be used for new applications.
