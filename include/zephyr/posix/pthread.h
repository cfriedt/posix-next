...
extern void k_thread_cleanup_push(void *cleanup[3], void (*routine)(void *arg), void *arg);
extern void k_thread_cleanup_pop(int execute);

#define pthread_cleanup_push(_rtn, _arg)                                                           \
	do /* enforce '{'-like behaviour */ {                                                      \
		void *_z_pthread_cleanup[3];                                                       \
	k_pthread_cleanup_push(_z_pthread_cleanup, _rtn, _arg)
