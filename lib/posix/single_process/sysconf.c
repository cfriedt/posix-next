...
long sysconf(int name)
{
	...
	case _SC_PRIORITIZED_IO:
		return COND_CODE_1(CONFIG_POSIX_PRIORITIZED_IO, (_POSIX_VERSION), (-1L));
	...
	case _SC_SYNCHRONIZED_IO:
		return COND_CODE_1(CONFIG_POSIX_SYNCHRONIZED_IO, (_POSIX_VERSION), (-1L));
	...
	case _SC_THREAD_PRIO_PROTECT:
		return COND_CODE_1(CONFIG_POSIX_THREAD_PRIO_PROTECT, (_POSIX_VERSION), (-1L));
...
#if defined(CONFIG_POSIX_FILE_LOCKING) && defined(CONFIG_POSIX_FILE_SYSTEM_R) &&                   \
	defined(CONFIG_POSIX_C_LANG_SUPPORT_R)
	...
	case _SC_TIMEOUTS:
		return COND_CODE_1(IS_ENABLED(CONFIG_POSIX_TIMEOUTS), (_POSIX_VERSION), (-1L));
	case _SC_TIMERS:
	...
	case _SC_XOPEN_REALTIME_THREADS:
		return COND_CODE_1(CONFIG_XSI_REALTIME_THREADS, (_XOPEN_VERSION), (-1));
	case _SC_XOPEN_SHM:
		return -1L;
