...
#ifndef TESTS_POSIX_THREAD_SPORADIC_SERVER_SRC_THREAD_SPORADIC_SERVER_TESTS_H_
#define TESTS_POSIX_THREAD_SPORADIC_SERVER_SRC_THREAD_SPORADIC_SERVER_TESTS_H_
...
#endif /* TESTS_POSIX_THREAD_SPORADIC_SERVER_SRC_THREAD_SPORADIC_SERVER_TESTS_H_ */
