...
.. csv-table:: POSIX System Interfaces
   ...
   :widths: 50, 10, 50
    ...
    :ref:`_POSIX_THREAD_SAFE_FUNCTIONS<posix_option_thread_safe_functions>`, -1, :kconfig:option:`CONFIG_POSIX_C_LANG_SUPPORT_R` or :kconfig:option:`CONFIG_POSIX_FILE_SYSTEM_R` or :kconfig:option:`CONFIG_POSIX_FILE_LOCKING` or :kconfig:option:`CONFIG_POSIX_SYSTEM_DATABASE_R`
