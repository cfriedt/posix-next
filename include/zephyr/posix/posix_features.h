...
#if defined(_POSIX_AEP_REALTIME_MINIMAL) && defined(CONFIG_POSIX_FD_MGMT) &&                       \
	defined(CONFIG_POSIX_FILE_SYSTEM) && defined(CONFIG_POSIX_MESSAGE_PASSING)
...
#if defined(CONFIG_POSIX_MULTI_PROCESS) && defined(CONFIG_POSIX_SIGNALS)
...
#undef _POSIX_THREAD_SAFE_FUNCTIONS
	...
	defined(CONFIG_POSIX_FILE_LOCKING) || defined(CONFIG_POSIX_SYSTEM_DATABASE_R)
...
#undef _XOPEN_REALTIME_THREADS
	...
	(defined(CONFIG_POSIX_THREAD_PRIO_INHERIT) && defined(CONFIG_POSIX_THREAD_PRIO_PROTECT) && \
	 defined(CONFIG_POSIX_THREAD_PRIORITY_SCHEDULING))
#define _XOPEN_REALTIME_THREADS _XOPEN_VERSION
#endif
