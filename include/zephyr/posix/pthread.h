...
/**
 * @defgroup posix_threads POSIX Threads
...
/** @brief Value returned by pthread_join() for a cancelled thread. */
...
#endif
/** @brief Default mutex type; behaviour on deadlock/unlock-by-non-owner is undefined. */
...
/** @brief Robust mutex; the state is recoverable if the owner dies. */
#define PTHREAD_MUTEX_ROBUST        4
/** @brief Mutex is not recovered on owner death (default, for non-robust mutexes). */
#define PTHREAD_MUTEX_STALLED       1
/** @brief Static initialiser for pthread_once_t objects. */
#define PTHREAD_ONCE_INIT           _PTHREAD_ONCE_INITIALIZER
#if defined(_POSIX_THREAD_PRIO_INHERIT) || defined(__DOXYGEN__)
/** @brief Mutex protocol: owning thread inherits priority of highest-priority waiter. */
...
/** @brief Static initialiser for pthread_cond_t objects. */
#define PTHREAD_COND_INITIALIZER   _PTHREAD_COND_INITIALIZER
/** @brief Static initialiser for pthread_mutex_t objects. */
#define PTHREAD_MUTEX_INITIALIZER  _PTHREAD_MUTEX_INITIALIZER
/** @brief Static initialiser for pthread_rwlock_t objects. */
...
/**
 * @defgroup posix_barriers POSIX Barriers
...
/**
 * @defgroup posix_cond POSIX Condition Variables
 * @ingroup posix_option_group_threads_base
 * @{
 */
...
/**
 * @defgroup posix_mutex POSIX Mutexes
 * @ingroup posix_option_group_threads_base
 * @{
 */
...
/**
 * @defgroup posix_rwlocks POSIX Reader-Writer Locks
...
/**
 * @defgroup posix_spinlocks POSIX Spin Locks
...
/**
 * @defgroup posix_threads_gnu POSIX Threads GNU Extensions
