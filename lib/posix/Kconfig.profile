...
config POSIX_AEP_CHOICE_PSE53
	...
	help
	  ...
	  option groups POSIX_MULTI_PROCESS, POSIX_NETWORKING, and POSIX_PIPE; and
	  options _POSIX_CPUTIME, _POSIX_PRIORITY_SCHEDULING, _POSIX_RAW_SOCKETS,
	  _POSIX_SPAWN, and _POSIX_SPORADIC_SERVER.
...
config POSIX_AEP_REALTIME_DEDICATED
	...
	help
	  ...
	  POSIX_MULTI_PROCESS, POSIX_NETWORKING, POSIX_PIPE, _POSIX_CPUTIME,
