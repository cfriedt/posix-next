...
.. csv-table:: POSIX System Interfaces
   ...
   :widths: 50, 10, 50
    ...
    :ref:`_POSIX_THREADS<posix_option_group_threads_base>`, -1, :kconfig:option:`CONFIG_POSIX_THREADS` (complete)
...
.. csv-table:: POSIX System Interfaces (Optional)
   ...
   :widths: 50, 10, 50
    ...
    _XOPEN_REALTIME_THREADS, 700, :kconfig:option:`CONFIG_XSI_THREADS_EXT`
