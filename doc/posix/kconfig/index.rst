...
Search all Kconfig options known to posix-next — those defined by this module
as well as those from the Zephyr tree it builds against:
...
* :kconfig:option:`CONFIG_ZEPHYR_GETOPT_LONG`
...
* :kconfig:option:`CONFIG_SYS_THREAD`
